...
<p>
Escape To Shape LLC ("us", "we", or "our") uses cookies on the https://www.escapetoshape.com website (the "Service"). By using the Service, you consent to the use of cookies.</p>
<p>
...
<h4>How Escape To Shape LLC uses cookies</h4>
<p>
When you use and access the Service, we may place a number of cookies files in your web browser.</p>
...
<li><strong>Accounts-related cookies. </strong> We may use accounts-related cookies to authenticate users and prevent fraudulent use of user accounts. We may use these cookies to remember information that changes the way the Service behaves or looks, such as the "remember me" functionality.</li>
...
<a href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored" target="_blank">https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored</a></li>
<li>
For the Safari web browser, please visit this page from Apple: <a href="https://support.apple.com/kb/PH21411?locale=en_US" target="_blank">
https://support.apple.com/kb/PH21411?locale=en_US
</a></li>
</ul>
<p>
For any other web browser, please visit your web browser's official web pages.
Where can you find more information about cookies</p>
<p>
You can learn more about cookies and the following third-party websites:</p>
<ul>
	<li>AllAboutCookies: <a href="http://www.allaboutcookies.org/" _target="http://www.allaboutcookies.org/">http://www.allaboutcookies.org/</a></li>
